...
let choosedTime = 0;
let timerTime = 0;
new (0, _flatpickrDefault.default)("#datetime-picker", {
    enableTime: true,
    time_24hr: true,
    ...
    onClose (selectedDates) {
        ...
        if (choosedTime < Date.now()) alert("Choose the time in the future");
        return choosedTime;
    }
});
...
},{}],"eVN6V":[function() {},{}]},["8lKsl","1AWyZ"], "1AWyZ", "parcelRequire4c75")
